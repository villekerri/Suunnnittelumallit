...
public class Motherboard implements Laiteosa{
    private String valmistaja;
    private int hinta;
    private ArrayList<Laiteosa> sisaltaa = new ArrayList<Laiteosa>();
    
    public Motherboard(String valmistaja, int hinta) {
    ...
    public String toString(){
        String s = "Motherboard, valmistaja: " + this.valmistaja + ", hinta: " + this.hinta + ", sisältää osat: \n";
        for (Laiteosa osa : sisaltaa) {
            s += "   " + osa.toString() + "\n";
        }
        return s;
